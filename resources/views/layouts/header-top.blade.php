<nav class=" navbar navbar-expand-lg mainNav  ">
    ...
    <div class="container">
        ...
        <div class=" collapse navbar-collapse " id="navbarSupportedContent">
            @auth
                <ul class="navbar-nav ">
                    <li class="nav-item active  w-100 mr-2">
                        <a class="nav-link wishlistIconContainer" href="{{ url('profile') }}">
                            <img src="{{ auth()->user()->avatarUrl() }}" alt="avtar"
                                 class="rounded-circle" >
                        </a>
                    </li>
                    <li class="nav-item dropdown w-100 mt-1">
                        <a class="nav-link bellNotificationContainer" data-toggle="dropdown" href="#"
                           aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right"
                             style="left: inherit; right: 0px; width:350px">
                                       ...
                                       href="{{ $notification->data['url'] }}?notify_id={{ $notification->id }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-10">
                                                ...
                                                <p class="text-muted"
                                                   style="font-size:0.8rem;white-space: nowrap; overflow: hidden; text-overflow: ellipsis !important ;"> {{ $notification->data['body'] }} </p>
                                            </div>
                                        </div>
                                    </a>
                                @empty
                    ...
                    <li class="nav-item active  w-100 mt-1">
                        ...
                        <a class="nav-link wishlistIconContainer" href="{{ route('wishlist.index') }}">
                            ...
                            <span
                                ...
                                id="WishlistCount"
                            >{{ Auth::user()->wishlist->products()->count() }}</span>
                        </a>
