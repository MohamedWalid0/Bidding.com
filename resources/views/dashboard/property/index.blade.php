...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between ">
            ...
            <a data-target="#modal-create-category" data-toggle="modal" class="btn btn-sm btn-primary ml-auto"> Create
                New Property </a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <table class="table table-bordered">
                ...
                @foreach ($properties as $property)
                    <tr class="text-center">
                        ...
                        <td>{{ $property->name }}</td>
                        <td>
                            @can('update' ,\App\Models\Property::class )
                                <button data-target="#modal-{{ $property->id }}" data-toggle="modal"
